...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/12 15:33:13 by mabdelou          #+#    #+#             */
/*   Updated: 2022/10/12 15:34:31 by mabdelou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if(F_garde_signe > 150 || F_garde_execute > 150)
       throw Form::GradeTooLowException();
    else if (F_garde_signe < 1 ||  F_garde_execute < 1)
        throw Form::GradeTooHighException();
